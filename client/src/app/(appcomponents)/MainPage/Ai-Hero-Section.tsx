            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <button className="p-[3px] relative">
                        ...
                        <div className="px-6 py-1 bg-black rounded-[6px] cursor-pointer  relative group transition duration-200 text-white hover:bg-transparent" onClick={()=>router.push("/todos")}>
                            Lets Study
                        </div>
                    </button>
